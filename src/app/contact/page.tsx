            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">hello@devcorp.com</p>
              ...
              <div className="pt-8 border-t border-neutral-200">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-neutral-200 rounded-lg flex items-center justify-center hover:bg-neutral-300 transition-colors">
                    <span className="text-neutral-600 font-semibold">X</span>
                  </a>
                  <a href="#" className="w-10 h-10 bg-neutral-200 rounded-lg flex items-center justify-center hover:bg-neutral-300 transition-colors">
                    <span className="text-neutral-600 font-semibold">LI</span>
                  </a>
                  <a href="#" className="w-10 h-10 bg-neutral-200 rounded-lg flex items-center justify-center hover:bg-neutral-300 transition-colors">
                    <span className="text-neutral-600 font-semibold">GH</span>
                  </a>
                  <a href="#" className="w-10 h-10 bg-neutral-200 rounded-lg flex items-center justify-center hover:bg-neutral-300 transition-colors">
                    <span className="text-neutral-600 font-semibold">YT</span>
                  </a>
                </div>
              </div>
            </div>
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-400 text-neutral-900"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="w-full px-4 py-3 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-neutral-400 text-neutral-900 resize-vertical"
                ...
                <button
                  type="submit"
                  className="w-full bg-neutral-900 text-white py-3 px-6 rounded-md hover:bg-neutral-800 transition-colors font-medium"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6">
            <div className="border border-neutral-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-neutral-900 mb-3">How long does a typical project take?</h3>
            ...
            <div className="border border-neutral-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-neutral-900 mb-3">Do you work with startups or only established companies?</h3>
              <p className="text-neutral-700">
            ...
            <div className="border border-neutral-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-neutral-900 mb-3">What technologies do you specialize in?</h3>
              <p className="text-neutral-700">
            ...
            <div className="border border-neutral-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-neutral-900 mb-3">Do you provide ongoing support after project completion?</h3>
              <p className="text-neutral-700">
